...
rule multiqc:
    # reporting tool 
    input: 
        fastqc = expand('results/fastqc/{samples}_R1_001_fastqc.zip', 'results/fastqc/{samples}_R2_001_fastqc.zip', samples = SAMPLES) # input all outputs from fastqc as one input 
    output: 
